...
- ### Relacionamentos:
  - A tabela tb_avaliacoes está relacionada à tabela tb_filmes através da chave estrangeira "filme_id", através de uma relação muitos para um, ou seja, um filme pode ter diversas avaliações conectadas a ele.
